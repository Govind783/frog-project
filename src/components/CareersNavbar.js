...
const CareersNavbar = () => {
    ...
    useEffect(() => {
        if (open == false) {
            document.querySelector(".Careernavbar").classList.add("z99")
        }

        else {
            document.querySelector(".Careernavbar").classList.remove("z99")
        }
    ...
    return (
        <div>
            ...
            <div className="Careernavbar pb-8 bg-black flex justify-around pr-6">
                <div className="">
                ...
                {width <= 1145 ? <>
                    ...
                    <div className="flex-none">
                        <ul className="flex gap-11 mt-6 capitalize px-1 fontfam">
                            ...
                            <li className=' CareersfontItemsDesktop'><Link>stellar doc</Link></li>
                            <li className=' inline-block CareersnavIconsDesktop '><Link><FaTelegramPlane className=' text-2xl inline-block' /></Link></li>
                            <li className=' inline-block CareersnavIconsDesktop '><Link><FaTwitter className=' text-2xl inline-block' /> </Link></li>
                            <li className='CareersfontItemsDesktop'><Link>more <AiFillCaretDown className=' inline-block text-sm pb-1' /></Link></li>
                        </ul>
                    </div>
