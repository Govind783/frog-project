...
const AstroNomicsMobile = () => {
    ...
    return (
        <div className='careersMainParent'>
            ...
            <div className='jobDetailsMainParent gap-16 text-black text-left font-medium flex flex-wrap popinsFont'>
...
export default AstroNomicsMobile