...
const Navbar = () => {
    ...
    useEffect(() => {
        if (open == false) {
            document.querySelector(".navbar").classList.add("z99")
        }

        else {
            document.querySelector(".navbar").classList.remove("z99")
        }
    ...
    return (
        <div>
            ...
            <div className="navbar pb-8 bg-black flex justify-around pr-6">
                <div className="">
                ...
                {width <= 1145 ? <>
                    ...
                    <div>
                        <div onClick={() => setIsOpen(!isOpen)} className="mt-8">
                            ...
                            <ul className="flex flex-col gap-11 mt-6 capitalize px-1 fontfam">
                                ...
                                <nav className={`sidebar ${isOpen ? "open" : ""}`}>
                                    <div className='flex flex-col gap-11 mt-6 capitalize px-1 fontfam'>
                                        ...
                                        <li className=' inline-block fontItems '><Link><FaTelegramPlane className=' text-2xl inline-block' /></Link></li>

                                        <li className=' inline-block fontItems '><Link><FaTwitter className=' text-2xl inline-block' /> </Link></li>
                    ...
                    <div className="flex-none">
                        <ul className="flex gap-11 mt-6 capitalize px-1 fontfam">
                            <li className='fontItemsDesktop glitch text-white'><Link> <img src={nav1} className="nav1 relative" /></Link></li>
                            <li className='fontItemsDesktop'><button onClick={onOpenModal}>interstallar</button></li>
                            <li className='fontItemsDesktop'><Link>manifesto</Link></li>
                            <li className='fontItemsDesktop'><Link>buy <AiFillCaretDown className=' inline-block text-sm pb-1' /> </Link></li>
                            <li className='fontItemsDesktop'><Link>stellar doc</Link></li>
                            <li className=' inline-block navIconsDesktop '><Link><FaTelegramPlane className=' text-2xl inline-block' /></Link></li>
                            <li className=' inline-block navIconsDesktop '><Link><FaTwitter className=' text-2xl inline-block' /> </Link></li>
                            <li className='fontItemsDesktop'><Link>more <AiFillCaretDown className=' inline-block text-sm pb-1' /></Link></li>
                        </ul>
                    </div>
