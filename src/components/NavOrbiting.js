...
import orbitSinlePage from "../assets/orbitSinlePage.png"
    ...
    <div className='navFuelingMainParent pt-28'>
      ...
      <div className='navFuelingParent flex flex-wrap justify-evenly'>
        ...
        <div className='navFuelingTextContainer flex flex-col'>
          ...
          <h1 className='text-5xl fuelingHeading font-bold text-left pl-7 pr-5'>ORBITING P2E</h1>
        ...
        <div className='navFuelHold'>
          <img src={orbitSinlePage} className="navFuellingImg navFuellingImg2 zoom" />
        </div>
